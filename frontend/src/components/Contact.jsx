...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 relative z-10 bg-white border-t border-slate-200">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start reveal">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Email Card */}
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 flex items-start gap-4 hover:border-blue-400 transition-colors shadow-sm">
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-slate-500 mb-1">Email Enquiries</h4>
                <a href="mailto:icaingcit2027@cit.edu.in" className="text-sm font-bold text-slate-900 hover:text-blue-600 transition-colors font-mono">
                  icaingcit2027@cit.edu.in
                </a>
                <p className="text-[11px] text-slate-500 mt-1">Response within 24 hours</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 flex items-start gap-4 hover:border-blue-400 transition-colors shadow-sm">
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-slate-500 mb-1">Phone Contact</h4>
                <a href="tel:+914222572177" className="text-sm font-bold text-slate-900 hover:text-blue-600 transition-colors font-mono block">
                  +91 422 257 2177
                </a>
                <p className="text-[11px] text-slate-500 mt-1">Department of IT, CIT (Mon–Fri 9am–5pm IST)</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 flex items-start gap-4 hover:border-blue-400 transition-colors shadow-sm">
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-slate-500 mb-1">Conference Venue</h4>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200 shadow-md">
              ...
              <form noValidate onSubmit={handleContactSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="c-name" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                  ...
                  <div>
                    <label htmlFor="c-email" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                ...
                <div>
                  <label htmlFor="c-subject" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="c-message" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-widest transition-all shadow-md disabled:opacity-50"
                >
